...
// Truncates a &str and adds ellipsis if needed
...
pub fn help() -> Result<()> {
    ...
    let help_text = r#"    
        ...
        - sort
            Sorts tasks by completion status
...
mod tests {
    ...
    // Creates a persistent in-memory db connection
    ...
    fn test_rm_todo() {
        ...
        assert_eq!(
            todos.len(),
            2,
            "Wrong number of todo items returned by rm()"
        );
